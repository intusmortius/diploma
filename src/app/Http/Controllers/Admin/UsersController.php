...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['id', 'name', 'email', 'email_verified_at', 'worker_specialization', 'worker_group', 'worker_cathedra', 'worker_faculty', 'customer_work_place'],

            // set columns to searchIn
            ['id', 'name', 'email', 'two_factor_secret', 'two_factor_recovery_codes', 'worker_specialization', 'worker_group', 'worker_cathedra', 'worker_faculty', 'customer_work_place', 'about']
        );
