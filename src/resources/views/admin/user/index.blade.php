                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'worker_specialization'">{{ trans('admin.user.columns.worker_specialization') }}</th>
                                        <th is='sortable' :column="'worker_group'">{{ trans('admin.user.columns.worker_group') }}</th>
                                        <th is='sortable' :column="'worker_cathedra'">{{ trans('admin.user.columns.worker_cathedra') }}</th>
                                        <th is='sortable' :column="'worker_faculty'">{{ trans('admin.user.columns.worker_faculty') }}</th>
                                        <th is='sortable' :column="'customer_work_place'">{{ trans('admin.user.columns.customer_work_place') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.worker_specialization }}</td>
                                        <td>@{{ item.worker_group }}</td>
                                        <td>@{{ item.worker_cathedra }}</td>
                                        <td>@{{ item.worker_faculty }}</td>
                                        <td>@{{ item.customer_work_place }}</td>
